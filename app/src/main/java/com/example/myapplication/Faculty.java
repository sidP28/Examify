...
public class Faculty extends AppCompatActivity{
    ...
    public void createtest(View view) {
        Intent create = new Intent(Faculty.this,createtest.class);
        startActivity(create);
    }

    public void tests(View view) {
        Intent tests = new Intent(Faculty.this, past_tests.class);
        startActivity(tests);
    }

    public void profile(View view) {
        Intent profile = new Intent(Faculty.this,profile.class);
